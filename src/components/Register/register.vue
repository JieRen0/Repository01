  ...
  <div class="login-container">
    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title" style="margin-left:-20%">请注册账号</h3>
      </div>
      ...
      <el-button :loading="loading" id="button1"   @click.native.prevent="handleLogin">注册</el-button>
      ...
      <div class="tips">
        ...
        <span style="margin-left:250px;"><router-link to="/complete">注册完成？去登录！</router-link></span>
        <router-view></router-view>
      </div>  
...
.login-container {
  ...
  min-height: 100%;
  width: 100%;
  background: url(../../assets/404_images/register01.png) ;
  background-size:100% ;
  background-color: $bg;
  overflow: hidden;
  display: flex;
